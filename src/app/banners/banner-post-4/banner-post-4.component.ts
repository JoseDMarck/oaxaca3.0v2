...
@Component({
  selector: 'app-banner-post-4',
  templateUrl: './banner-post-4.component.html',
  styleUrls: ['./banner-post-4.component.css']
})
export class BannerPost4Component implements OnInit {
