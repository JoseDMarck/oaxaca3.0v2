...
@Component({
  selector: 'app-banner-post-1',
  templateUrl: './banner-post-1.component.html',
  styleUrls: ['./banner-post-1.component.css']
})
export class BannerPost1Component implements OnInit {
 post: Post;
   categoria:any;
  ...
  getBanners(){
    this.postsService
      ...
      .subscribe(res => {
        this.post = res[0];
        this.banner_personal = res[0].imagen_banner_post_1;
        this.banner_url = res[0].url_banner_post_1;
