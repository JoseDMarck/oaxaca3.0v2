...
@Component({
  selector: 'app-banner-post-5',
  templateUrl: './banner-post-5.component.html',
  styleUrls: ['./banner-post-5.component.css']
})
export class BannerPost5Component implements OnInit {
  ...
  getBanners(){
    this.postsService
      ...
      .subscribe(res => {
        this.post = res[0];
        this.banner_personal = res[0].imagen_banner_post_4;
        this.banner_url = res[0].url_banner_post_4;
