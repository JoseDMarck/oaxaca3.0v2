...
@Component({
  selector: 'app-banner-post-2',
  templateUrl: './banner-post-2.component.html',
  styleUrls: ['./banner-post-2.component.css']
})
export class BannerPost2Component implements OnInit {
  ...
  getBanners(){
    this.postsService
      ...
      .subscribe(res => {
        this.post = res[0];
        this.banner_personal = res[0].imagen_banner_post_2;
        this.banner_url = res[0].url_banner_post_2;
